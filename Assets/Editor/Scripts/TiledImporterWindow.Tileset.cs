                ...
                case btThingShape.cube:
                    {
                        ...
                        thingConfig.pixelSize = new FVector3 { x = image.width, y = cube_y_height, z = image.height - cube_y_height };
                    }
                    break;

                case btThingShape.xy:
                    {
                        thingConfig.pixelSize = new FVector3 { x = image.width, y = image.height, z = 0 };
                    }
                    break;

                case btThingShape.xz:
                    {
                        thingConfig.pixelSize = new FVector3 { x = image.width, y = 0, z = image.height };
                    }
                    break;
