...
namespace Script
{
    public class DBInsertAccount : DBQuery
    {
        ...
        public override async Task<MyResponse> handle(TcpClientData socket, object _msg)
        {
            ...
            var param = this.MakeParameters(new List<object> { a.platform, a.channel, a.channelUserId, a.playerId, this.server.SecondsToDateTime(a.createTimeS), a.oaid, a.imei, a.userInfo });
